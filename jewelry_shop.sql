...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2022 at 09:09 PM
...
('kimmy', 'ss@gmail.com'),
('nookie', 'nook@ie.com'),
('pailin', 'a@hotmail.com'),
('rose', 'ro@se.s'),
('บุญหลาย', 'Aol@gmail.com');
...
('0000-00-00', '12:01:00', 1, 'rose', 8, 'confirm'),
('0000-00-00', '12:01:00', 1, 'rose', 9, 'paid'),
('2022-02-02', '12:12:12', 1, 'rose', 9, 'paid'),
('2022-02-02', '12:12:12', 1, 'rose', 19, 'paid'),
('2022-10-10', '15:55:55', 1, 'jenniekim', 1, 'ฟรี้ดดดด'),
('2022-10-10', '15:55:55', 1, 'jenniekim', 2, 'paid'),
('2022-11-18', '16:00:00', 1, 'jenniekim', 17, 'paid'),
('2022-11-18', '16:00:00', 2, 'jenniekim', 2, 'paid'),
('2022-11-19', '08:00:50', 1, 'rose', 9, 'paid'),
('2022-11-19', '08:00:50', 1, 'rose', 19, 'paid'),
('2022-11-19', '08:00:50', 4, 'rose', 3, 'confirm'),
('2022-11-20', '02:03:08', 1, 'rose', 7, 'confirm'),
('2022-11-20', '02:34:40', 1, 'rose', 15, 'paid'),
('2022-11-20', '02:34:40', 1, 'rose', 17, 'confirm'),
('2022-11-20', '11:01:23', 1, 'jenniekim', 1, 'paid'),
('2022-11-23', '04:29:33', 1, 'jenniekim', 2, 'paid'),
('2022-11-23', '06:00:16', 2, 'jenniekim', 13, 'paid'),
('2022-11-23', '12:27:20', 1, 'jenniekim', 2, 'confirm'),
('2022-11-23', '12:42:59', 1, 'pailin', 2, 'paid'),
('2022-11-23', '12:51:24', 1, 'pailin', 3, 'paid'),
('2022-11-23', '12:51:24', 1, 'pailin', 4, 'paid');
...
(1, 'สร้อยลายใบแปะก๊วย', '1200', 20, 'T001'),
(2, 'สร้อยเงินลายไม้กางเขน', '550', 3, 'T001'),
(3, 'สร้อยลายโซ่สีทอง', '690', 5, 'T001'),
(4, 'สร้อยทรงแบนสีทอง', '690', 14, 'T001'),
(5, 'สร้อยจี้สี่้หลี่ยมสีทอง', '790', 14, 'T001'),
(6, 'สร้อยจี้ลายหินอ่อน', '560', 14, 'T001'),
(7, 'ต่างหูมุก', '450', 12, 'T003'),
(8, 'ต่างหูรูปดาว', '690', 9, 'T003'),
(9, 'ต่างหูรูปใบไม้', '450', 7, 'T003'),
(10, 'ต่างหูทรงหยดน้ำสีทอง', '720', 15, 'T003'),
(11, 'ต่างหูแบบหนีบทรงกลม', '450', 10, 'T003'),
(12, 'ต่างหูลายขวางขดกลม', '890', 20, 'T003'),
(13, 'แหวนทองลายเรียบ', '850', 18, 'T002'),
(14, 'แหวนเงินลายเรียบ', '690', 20, 'T002'),
(15, 'แหวนเพชรทรงมาคีสีทอง', '1590', 14, 'T002'),
(16, 'แหวนเพชรเงินลายโซ่', '1250', 20, 'T002'),
(17, 'กำไลลายโซ่สีทอง', '750', 13, 'T004'),
(18, 'กำไลสีทองเส้นเล็ก', '450', 14, 'T004'),
(19, 'กำไลลายเลขโรมันสีเงิน', '850', 17, 'T004'),
(20, 'กำไลเพชรลายคลื่นสีทอง', '1650', 20, 'T001');
...
--
ALTER TABLE `po`
  ADD PRIMARY KEY (`date_order`,`time_order`,`qty_product`,`username_cus`,`id_product`),
...
--
ALTER TABLE `product`
  MODIFY `id_product` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
